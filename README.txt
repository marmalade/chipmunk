...
CHIPMUNK4AIRPLAY NOTES:
-----------------------

This is Chipmunk 5.4.3 set up as an Airplay SDK subproject. 

For more info on Chipmunk, look here:

 - http://code.google.com/p/chipmunk-physics/
 - http://www.slembcke.net/forums/viewforum.php?f=1

I've only done a basic test with stacks of boxes, but that has worked very so far, with the PC x86 and ARM builds, and on an iPhone 4 and first-gen iPod Touch.


The Chipmunk code mostly compiles as-is with the Airplay build system, it took very little effort to get it up and running

The following changes were made:

- Airplay .mkf subproject file created
- All .c files renamed to .cpp (solves most of the build issues with Airplay)
- Floats are used by default, not doubles
- INFINITY define renamed to CP_INFINITY (to avoid possible conflicts with Airplay's INFINITY)
- Fixed a memory leak (see this thread: http://www.slembcke.net/forums/viewtopic.php?f=3&t=210)



To include it in your project, put the Chipmunk4Airplay directory within your project directory. You'll need to add the subproject:

subprojects
{
    source\Chipmunk4Airplay
}

And also the include paths:

includepath
{
    source\Chipmunk4Airplay
    source\Chipmunk4Airplay\include\chipmunk
}

(This assumes that you've put it in <projectdir>\source\)


You'll probably also want to use arm-fpu=1



ORIGINAL CHIPMUNK README:
-------------------------
